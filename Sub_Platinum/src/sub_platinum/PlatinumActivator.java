...
public class PlatinumActivator implements BundleActivator {
	...
	public void start(BundleContext bundleContext) throws Exception {
		...
		double tot = 0;
		double dis = 0;
		float disPercentage = (float) 0.20;
		...
		System.out.println("Platinum Subscriber has started.");
		System.out.println("\n================================ Publishers ================================");
	...
	public void stop(BundleContext bundleContext) throws Exception {
		System.out.println("Platinum Subscriber Has Stopped.");
