...
public class SilverActivator implements BundleActivator {
	...
	public void start(BundleContext bundleContext) throws Exception {
		...
		double tot = 0;
		double dis = 0;
		float disPercentage = (float) 0.10;
		...
		AdventurePublisher adventurePub = (AdventurePublisher) bundleContext
				.getService(serviceRefAdventure);
		
		serviceRefSafari= bundleContext.getServiceReference(SafariPublisher.class.getName());
		SafariPublisher safariPub = (SafariPublisher) bundleContext
				.getService(serviceRefSafari);
		
		serviceRefHillClimbing= bundleContext.getServiceReference(HillClimbPublisher.class.getName());
		HillClimbPublisher hillClimbPub = (HillClimbPublisher) bundleContext
				.getService(serviceRefHillClimbing);

	

		// Get inputs and Organize output

		System.out.println("Silver Subscriber has started.");
		System.out.println("\n================================ Publishers ================================");
	...
	public void stop(BundleContext bundleContext) throws Exception {
		System.out.println("Silver Subscriber Has Stopped.");
